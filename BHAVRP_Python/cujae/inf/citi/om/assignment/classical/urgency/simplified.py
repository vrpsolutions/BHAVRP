...
class Simplified(ByUrgency):
    ...
    def to_clustering(self) -> Solution:
        ...
        total_items: int = len(list_customers_to_assign)
        ...
        while list_customers_to_assign and list_clusters:
            ...
            if pos_cluster != -1:
                cluster = list_clusters[pos_cluster]
                ...
                if capacity_depot >= (request_cluster + request_customer):
                    ...
                    del list_customers_to_assign[pos_customer]
                    del list_urgencies[pos_customer]
                    del list_depots_ordered[pos_customer]
                else:
                    if capacity_depot > request_cluster:
                        ...
                        if not list_depots_ordered[pos_customer]:
                            ...
                            list_urgencies[pos_customer] = self.get_urgency(
                                id_customer, list_id_depots[0], urgency_matrix, total_items
                            )
                    else:
                        pos_depot = Problem.get_problem().find_pos_element(
                            id_customer, list_id_depots[0], urgency_matrix, -1
                        )

...
public class Clara extends ByMedoids { 
	...
	public void initialize() {
		listPartitions = generatePartitions(sampsize, samplingType);
	...
	private void stepSearchMedoids(ArrayList<Cluster> clusters, ArrayList<Depot> medoids, NumericMatrix costMatrix, double bestCost, ArrayList<Customer> listPartition){
	...
	private double calculateCost(ArrayList<Cluster> clusters, NumericMatrix costMatrix, ArrayList<Depot> medoids, ArrayList<Customer> listPartition) {
		double cost = 0.0;

...
public class InfoProblem {
	...
	private static InfoProblem problem = null;
	...
	public static InfoProblem getProblem () {
		if (problem == null) {
			problem = new InfoProblem();
		}
		return problem;
	}
	...
	public NumericMatrix fillCostMatrix(ArrayList<Customer> customers, ArrayList<Depot> depots, DistanceType distanceType) throws IllegalArgumentException, SecurityException, ClassNotFoundException, InstantiationException, IllegalAccessException, InvocationTargetException, NoSuchMethodException {
		...
		Distance distance = newDistance(distanceType);
	...
	private Distance newDistance(DistanceType distanceType) throws IllegalArgumentException, SecurityException, ClassNotFoundException, InstantiationException, IllegalAccessException, InvocationTargetException, NoSuchMethodException {
